...
export const JobPostingSchema = component$<JobPostingSchemaProps>((props) => {
    const schema: Record<string, unknown> = {
        ...
        "hiringOrganization": {
            ...
            ...(props.hiringOrganization.sameAs && { "sameAs": props.hiringOrganization.sameAs }),
    ...
    if (props.employmentType) {
        ...
        schema["employmentType"] = typeMap[props.employmentType.toLowerCase()] || "OTHER";
    }
    ...
    if (props.jobLocation && !props.isRemote) {
        schema["jobLocation"] = {
            ...
            "address": {
                "@type": "PostalAddress",
                ...(props.jobLocation.addressLocality && { "addressLocality": props.jobLocation.addressLocality }),
                ...(props.jobLocation.addressRegion && { "addressRegion": props.jobLocation.addressRegion }),
                ...(props.jobLocation.addressCountry && { "addressCountry": props.jobLocation.addressCountry || "IT" })
            }
        };
    }
...
export const BreadcrumbSchema = component$<BreadcrumbSchemaProps>(({ items }) => {
    const schema = {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
