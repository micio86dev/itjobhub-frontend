      ...
      <div class="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        {!isAuthenticated && (
          <div class="flex justify-center space-x-4">
            <a
              href="/register"
              class="bg-white text-indigo-900 px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              {t("home.register_free")}
            </a>
            <a
              href="/login"
              class="bg-transparent border-2 border-indigo-400 text-indigo-100 px-8 py-4 rounded-lg font-bold hover:bg-indigo-800/50 transition-colors"
            >
              {t("home.login")}
            </a>
          </div>
