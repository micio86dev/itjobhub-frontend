...
export const Logo = component$(() => {
  return (
    <div class="group flex items-center gap-3 font-mono select-none">
      ...
      <span class="font-bold text-gray-900 dark:group-hover:text-brand-neon dark:text-gray-100 group-hover:text-brand-neon text-xl tracking-tight transition-colors duration-300">
