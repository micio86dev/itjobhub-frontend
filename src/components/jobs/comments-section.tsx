        ...
        {isAuthenticated ? (
            ...
            <div class="flex gap-3">
              ...
              <div class="flex-1">
                ...
                <div class="flex justify-end mt-2">
                  ...
                  >
                    {state.isSubmitting ? 'Invio...' : 'Commenta'}
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="mb-4 p-3 bg-gray-50 rounded-md">
            <p class="text-sm text-gray-600 text-center">
              ...
              {' '}per commentare questo annuncio
            </p>
          </div>
        )}
      </div>
      ...
      <div class="space-y-4">
        {comments.length === 0 ? (
          <div class="text-center py-6">
            ...
            <p class="text-sm text-gray-500">Nessun commento ancora</p>
            <p class="text-xs text-gray-400">Sii il primo a commentare!</p>
          </div>
        ) : (
