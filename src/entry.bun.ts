      ...
      if (qwikCityResponse) {
        ...
        if (
          ...
          const csp = [
            ...
            `connect-src 'self'${Bun.env.PUBLIC_API_URL ? ` ${Bun.env.PUBLIC_API_URL}` : ""} https://vitals.vercel-insights.com https://fonts.googleapis.com https://fonts.gstatic.com https://maps.googleapis.com https://c.clarity.ms https://j.clarity.ms https://www.clarity.ms`,
