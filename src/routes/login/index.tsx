            ...
            >
              {form.loading && form.provider === 'email' && (
                <svg class="spinner" fill="none" viewBox="0 0 24 24">
                  <circle class="spinnerBase" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                  <path class="spinnerPath" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
              )}
              {form.loading && form.provider === 'email' ? t('auth.logging_in') : t('auth.login_btn')}
            </button>
          </div>
        </form>
        ...
        <div class="dividerContainer">
          ...
          <div class="socialGrid">
            <button
              ...
              class="socialButton"
            >
              {form.loading && form.provider === 'google' ? (
            ...
            <button
              ...
              class="socialButton"
            >
              {form.loading && form.provider === 'linkedin' ? (
                <svg class="socialSpinner" fill="none" viewBox="0 0 24 24">
                  <circle class="spinnerBase" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                  <path class="spinnerPath" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
            ...
            <button
              ...
              class="socialButton"
            >
              {form.loading && form.provider === 'github' ? (
                <svg class="socialSpinner" fill="none" viewBox="0 0 24 24">
                  <circle class="spinnerBase" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                  <path class="spinnerPath" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
