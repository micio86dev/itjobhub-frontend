  ...
  useTask$(({ track }) => {
    ...
    if (result) {
      if (result.success) {
        ...
        form.error = result.error || result.message || translate('auth.login_failed', i18n.currentLanguage);
      }
      form.loading = false;
      ...
      <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" preventdefault:submit onSubmit$={handleLogin}>
          ...
          <div>
            ...
            >
              {form.loading ? t('auth.logging_in') : t('auth.login_btn')}
            </button>
          </div>
        </form>
        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-gray-50 text-gray-500">{t('auth.or_continue')}</span>
            </div>
          </div>
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: 'Accedi al tuo account ITJobHub',
    },
  ],
};